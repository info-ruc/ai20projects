...
if __name__=='__main__':
    ...
    # model = resnet101()
    #model = densenet121()
    model = torch.load("leafsnap_model.pth")

    model.linear = nn.Linear(50176, 80)
    #model.fc = nn.Linear(50176, 185)
    ...
    train_loader = torch.utils.data.DataLoader(data_train, batch_size=32, shuffle=True, num_workers=2)
    val_loader = torch.utils.data.DataLoader(data_test, batch_size=32, shuffle=False, num_workers=2)
